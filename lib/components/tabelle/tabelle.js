/* eslint-env browser */
import { listenFor, template2dom, extractContent, submitForm as submit } from '../../util'
...
export default class Tabelle extends HTMLElement {
  ...
  addListeners () {
    ...
    this.addEventListener('change', listenFor('tabelle-input', submitForm))
    this.addEventListener('change', listenFor('tabelle-arrow', submitForm))
    this.addEventListener('keyup', debounce(this.debounce, listenFor('tabelle-input', submitForm)))
